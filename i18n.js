...
(function () {
  ...
  const translations = {
    ru: {
      ...
      why_2_lead: "Привезем вовремя прямо к вашему столу",
      why_2_text: "Вам больше не нужно тратить время на поездки по городу. Мы бережно доставим ваш заказ в любую точку Атырау точно к назначенному часу. Курьер привезет десерт в идеальном виде, чтобы вы сразу могли подать его гостям.",
      why_3_title: "Честный и натуральный состав",
      why_3_lead: "Никакого маргарина и растительных жиров",
      why_3_text: "Мы готовим только из натуральных ингредиентов: используем настоящее сливочное масло 82.5%, свежие ягоды, отборные сливки и исключительно Халал-продукты. Качество, в котором вы можете быть уверены на 100%.",
    ...
    kk: {
      ...
      why_2_lead: "Уақытында үстеліңізге дейін жеткіземіз",
      why_2_text: "Қала бойынша жүріп уақыт жоғалтудың қажеті жоқ. Тапсырысыңызды Атыраудың кез келген нүктесіне белгіленген сағатқа дейін ұқыпты жеткіземіз. Курьер десертті мінсіз күйде әкеледі — қонақтарға бірден қоюға болады.",
      why_3_title: "Адал әрі табиғи құрам",
      why_3_lead: "Маргарин мен өсімдік майлары жоқ",
      why_3_text: "Тек табиғи ингредиенттерден дайындаймыз: нағыз 82.5% сары май, балғын жидектер, таңдаулы кілегей және тек Халал өнімдер. 100% сенім артатын сапа.",
