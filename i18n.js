...
(function () {
  ...
  const translations = {
    ru: {
      ...
      category_stage_desc_cakes: "Авторские торты для праздников и на каждый день — свежий крем и натуральные ингредиенты.",
      category_stage_desc_pastries: "Свежая выпечка из печи: самса, булочки, сочники и к чаю.",
      category_stage_desc_pies: "Домашние пироги с начинками — от мясных до сладких.",
      category_stage_desc_desserts: "Изысканные пирожные и десерты для особого настроения.",
    ...
    kk: {
      ...
      category_stage_desc_cakes: "Мереке мен күнделікті күнге арналған авторлық торттар — жаңа крем және табиғи ингредиенттер.",
      category_stage_desc_pastries: "Пештен жаңа пісірмелер: самса, тоқаш, сочник және шайға.",
      category_stage_desc_pies: "Үйдегідей пирогтар — етті және тәтті ішкіліктермен.",
      category_stage_desc_desserts: "Ерекше көңіл-күйге арналған талғампаз пирожныйлар мен десерттер.",
