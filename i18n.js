...
(function () {
  ...
  const translations = {
    ru: {
      ...
      about_text_1: "Кондитерский дом **Nazcake** уже более 15 лет радует жителей Атырау изысканными вкусами и теплой домашней атмосферой. Каждый день мы создаем свежую выпечку и десерты, приносящие радость в каждый дом.",
    ...
    kk: {
      ...
      about_text_1: "Nazcake кондитерлік үйі 15 жылдан астам уақыт бойы Атырау тұрғындарын талғампаз дәмдерімен және жылы үй атмосферасымен қуантып келеді. Күн сайын біз әр үйге қуаныш сыйлайтын жаңа пісірілген өнімдер мен десерттерді дайындаймыз.",
